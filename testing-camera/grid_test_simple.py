#!/usr/bin/env python3
"""
Simplified OAK-D S-2 Grid Test Camera - Working Version
"""
...
class SimpleGridTestCamera:
    ...
    def run_camera(self):
        """Main camera loop with grid overlay using simple approach"""
        try:
            ...
            with dai.Device() as device:
                ...
                while True:
                    ...
                    cv2.putText(frame, "OAK-D S-2 Camera (Simple)", (10, 60), 
...
def main():
    ...
    camera = SimpleGridTestCamera(grid_size=56)  # 56 pixels = 1 foot
    
    print("OAK-D S-2 Grid Test Camera System (Simple)")
    print("==========================================")
    print("Controls:")
